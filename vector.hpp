...
namespace ft {
	...
	class vector
	{
		public:
			...
			// vector (InputIterator first, InputIterator last, const allocator_type& alloc = allocator_type(), typename enable_if<!ft::is_integral< InputIterator >::value, void* >::type* = NULL): _alloc(alloc) {
